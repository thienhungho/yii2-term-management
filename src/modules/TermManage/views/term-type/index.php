...
/* @var $searchModel thienhungho\TermManagement\modules\TermManage\search\TermTypeSearch */
...
?>
<div class="term-type-index-head">
    <h1><?= Html::encode($this->title) ?></h1>
    <div class="row">
        <div class="col-lg-10">
            <p>
                <?= Html::a(t('app', 'Create Term Type'), ['create'], ['class' => 'btn btn-success']) ?>
...
<div class="term-type-index">
    ...
    <?= GridView::widget([
        ...
        'hover'          => true,
        'pjax'           => true,
        'pjaxSettings'   => ['options' => ['id' => 'kv-pjax-container-term-type']],
        'panel'          => [
